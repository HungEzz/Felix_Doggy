  ...
  return (
    <div style={{ display: 'flex', height: '100vh', background: 'var(--bg-secondary)', fontFamily: 'Inter, DM Sans, system-ui, sans-serif' }}>
      ...
      <div className="admin-mobile-header" style={{
        ...
        <button onClick={() => setSidebarOpen(o => !o)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'var(--text-primary)', display: 'flex', padding: 8 }}>
          {sidebarOpen ? <X size={22} /> : <Menu size={22} />}
        </button>
        <Disc3 size={22} strokeWidth={1.5} style={{ color: 'var(--text-primary)' }} />
        <span style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontWeight: 800, fontSize: 14, color: 'var(--text-primary)' }}>Admin</span>
      </div>
      ...
      {/* Main Content */}
      <main className="admin-main" style={{ flex: 1, overflowY: 'auto', background: 'var(--bg-secondary)' }}>
